...
import { getComment } from '@/shared/cache/comments'
...
class CommentComponent extends HTMLElement {
	constructor() {
		...
		wrapper.setAttribute('class', 'comments-block')
	    ...
	    .comments-block .comment-user .comment-user-details{
	        display: flex;
	        align-items: center;
	    }
	    user-avatar{
